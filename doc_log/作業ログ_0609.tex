...
\begin{itemize}
 ...
 \begin{itemize}
    \item 演奏開始・停止ボタンの実装
    \item 楽譜配列の完成
    \item ヴァイオリン音のスペクトラム分析・波形合成（進行中・進捗50\%）
 \end{itemize}
  ...
  \caption{作業ログ}
   \scalebox{0.7}{
    \begin{tabular}{lcccccc} \hline
      ...
      ヴァイオリン音 & 05/28 & 06/12 & 進行中 & 50\% & 楽器音 & - \\
      演奏開始・停止ボタン（実装） & 05/28 & 06/09 & 完了 & 100\% & 設計 & 追加実装・今週完了 \\
      開始停止スイッチテスト & 06/13 & 06/19 & 未着手 & 0\% & 実装の完了 & - \\
      楽器音テスト & 06/13 & 06/19 & 未着手 & 0\% & 実装の完了 & - \\
      \hline
    \end{tabular}
  }
\end{table}
...
\begin{itemize}
  ...
  \item 実施事項③：開始停止スイッチテスト
  \begin{itemize}
    \item 実装した演奏開始・停止スイッチについて，実際の演奏処理を含めた動作テストを実施する．
  \end{itemize}
  \item 達成基準：
  \begin{itemize}
    \item スイッチ押下により演奏の開始・停止が正しく切り替わり，チャタリングによる誤作動が発生しないこと．
  \end{itemize}
  \item 期限：2026/06/19
\end{itemize}
