...
結合対象は指揮者Arduino（conductor.ino），演奏者Arduino（player.ino + lyrics.h/cpp + katakana.h/cpp），およびProcessing側音源（soundPlayer.pde）の3項目である．指揮者LEDの色・点滅で音高・テンポ・音量を伝送し，演奏者がカラーセンサで受光してシリアル経由でProcessingに送信する構成である．\\
...
\begin{itemize}
  ...
  \begin{itemize}
      \item 本プロジェクト設計書．
      \item Arduino UNO R4 WiFi 公式リファレンス（WiFiS3 ライブラリ）．
  \end{itemize}
  \item 検証手順：
  \begin{enumerate}
